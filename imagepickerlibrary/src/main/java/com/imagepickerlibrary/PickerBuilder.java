...
import com.imagepickerlibrary.managers.CameraPickerManager;
...
public class PickerBuilder {
    ...
    public PickerBuilder(Activity activity, int type, boolean isCropRequired)
    {
        ...
        pickerManager.setCropRequired(isCropRequired);
    }
    ...
    {
        void onImageReceived(Uri imageUri, String realPath, File file);
    }
